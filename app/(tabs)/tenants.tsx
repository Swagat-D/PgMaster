...
import { View, Text, StyleSheet, TouchableOpacity, TextInput, Image, Dimensions, Platform, KeyboardAvoidingView, ScrollView } from 'react-native';
...
export default function Login() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top','bottom']}>
        ...
        <TouchableOpacity style={styles.sendBtn} activeOpacity={0.9} onPress={() => router.push(`/(auth)/otp?phone=${phone}`)}>
